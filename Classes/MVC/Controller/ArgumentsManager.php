 ...
 */
class ArgumentsManager implements SingletonInterface {
	...
	public function __construct() {
		$this->arguments = GeneralUtility::makeInstance('TYPO3\\CMS\\Extbase\\Persistence\\ObjectStorage');
	}
	 ...
	 * @return void
	 */
	public function registerArguments(Arguments $arguments) {
